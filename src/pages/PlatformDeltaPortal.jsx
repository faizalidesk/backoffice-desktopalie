...
export default function PlatformDeltaPortal() {
  ...
  return (
    <>
      <Header title="Platform Delta Workspace (Enterprise ERP & Cloud Portal)" />
          ...
          <div style={{
            ...
            <div style={{ flex: 1, minWidth: '300px' }}>
              ...
              <p style={{ color: '#94A3B8', fontSize: '0.925rem', margin: 0, maxWidth: '750px', lineHeight: '1.55' }}>
                Selamat datang di portal utama Platform Delta. Ruang kerja lengkap pemantauan server multi-node cluster, keuangan ERP enterprise, pool koneksi database, dan manajemen SLA 99.99%.
              </p>
            </div>
